...
//*********************************************************************************************************************************//
      $denunciaID_MP=trim($denunciaId);


      $IdOrigSum=intval($tipoDenuncia);
 ...
 if ($surc_origensumario=mysqli_query($conex_surc,$origensumario)) {
          ...
          //**********Acta***********************************//
            ...
            $SURC_Sumario_NroSumMP=trim($actaNro);
            // echo "SURC_Sumario_NroSumMP: ".$SURC_Sumario_NroSumMP.'<br>';

            $SURC_Sumario_NroSumMPAct=trim($actaNroActual);
          ...
          //*********año************************************//
            ...
            $SURC_Sumario_Anio=intval($Anio);
            // echo "SURC_Sumario_Anio: ".$SURC_Sumario_Anio.'<br>';


            $SURC_Sumario_AnioAct=intval($AnioActual);
            // echo "SURC_Sumario_AnioAct: ".$SURC_Sumario_AnioAct.'<br>';
            //**************************************************//

            //***********Dependencia****************************//

            $SURC_IdDepDestino=intval($dependenciaActualId);
            // echo "SURC_IdDepDestino=".$SURC_IdDepDestino.'<br>';


            $SURC_IdDepOrigen=intval($dependenciaCargaId);
            // echo "SURC_IdDepOrigen=".$SURC_IdDepOrigen.'<br>';

            $SiglaDep=trim($dependenciaCargaSigla);
            // echo "sigladep: ".$SiglaDep.'<br>';

            $SiglaDepACT=trim($dependenciaActualSigla);
